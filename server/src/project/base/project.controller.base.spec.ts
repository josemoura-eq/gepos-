...
const CREATE_INPUT = {
  ...
  createdAt: new Date(),
  endDate: new Date(),
  executeValue: "exampleExecuteValue",
  expectedResults: "exampleExpectedResults",
  Financing: "exampleFinancing",
  healthArea: "exampleHealthArea",
  id: "exampleId",
  municipality: "exampleMunicipality",
  objectives: "exampleObjectives",
  owner: "exampleOwner",
  projectValue: "exampleProjectValue",
  province: "exampleProvince",
  scope: "exampleScope",
  startDate: new Date(),
  targetAchieved: "exampleTargetAchieved",
  targetGroup: "exampleTargetGroup",
  targetPopulation: "exampleTargetPopulation",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  businessUnit: "exampleBusinessUnit",
