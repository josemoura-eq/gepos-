...
class ContributorUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => HealthAreaUpdateManyWithoutContributorsInput,
  })
  @ValidateNested()
  @Type(() => HealthAreaUpdateManyWithoutContributorsInput)
  @IsOptional()
  @Field(() => HealthAreaUpdateManyWithoutContributorsInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ObjectiveUpdateManyWithoutContributorsInput,
  })
  @ValidateNested()
  @Type(() => ObjectiveUpdateManyWithoutContributorsInput)
  @IsOptional()
  @Field(() => ObjectiveUpdateManyWithoutContributorsInput, {
    nullable: true,
  })
